sap.ui.define([
	...
	return Controller.extend("sap.demo.ConfirmTransfer.controller.shippingInstructionList", {
		...
		onInit : function() {
			...
			var oModelToSite = new JSONModel(jQuery.sap.getModulePath("sap.demo.MockData", "/filterShipToSite.json"));
			this.getView().setModel(oModelToSite, "filterShipToSite");
		...
		onPressSortDialog : function(oEvent) {
			if(!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("sap.demo.ConfirmTransfer.view.fragment.sortForTableSelectDialog", this);
			}
			this._oDialog.open();
		},
