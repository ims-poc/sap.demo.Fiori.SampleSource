sap.ui.define([
	...
	"sap/ui/Device",
	"sap/demo/ConfirmTransfer/model/models",
	"sap/demo/ConfirmTransfer/MyRouter",
	"sap/demo/ConfirmTransfer/Configuration",
	'sap/ui/model/json/JSONModel'
], 
function(UIComponent, Device, models, MyRouter, Configuration, JSONModel) {
	"use strict";
	
	jQuery.sap.require("sap.demo.ConfirmTransfer.util.Formatter");
	
	return UIComponent.extend("sap.demo.ConfirmTransfer.Component", {
